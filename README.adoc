...
mods, also known as plain _Doom_ or _Doom 1_. 
*Freedom Scoops Gold (WIP)*:: The game includes four episodes, a prologue and epilogue episodes, 
as well as First and Second Crunch which are mid episodes, each with nine levels, 
for a total of 36 levels. This game aims for compatibility with _Chex: Quest 3.
mods, also known as plain _Doom_ or _Doom 1_.
