...
The general rules go as follows:
  ...
  * You must have permission for everything you submit. If you make
    ...
    to generate art/sound resources. If you take work from other places, 
...
"Galactic Nutritional Alliance or (G.N.A.)" can be used on surfaces 
and textures as an example or maybe something generic should do.
