...
[horizontal]
*Freedom Scoops First Crunch*:: Single episode five levels, totaling ten, including added multiplayer levels within them.
This game aims for compatibility with _Chex: Quest_
mods, also known as plain _Doom_ or _Doom 1_. 
*Freedom Scoops Second Crunch*:: Single episode five levels, totaling ten, including added multiplayer levels within them.
This game aims for compatibility with _Chex: Quest 2_
mods, also known as plain _Doom_ or _Doom 1_. 
...
Hexar Waffleton is main character of the story you play as him the hero. Want to know more of the scoop read the story:
...
The general rules go as follows:
  ...
  * You must have permission for everything you submit. If you make
    ...
    other restricted work, and do not use artificial intelligence 
    to generate resources. If you take work from other places, 
    please make sure that the work is freely-licensed or that you obtain permission to 
    include it in the _Freedom Scoops_ project. They may not place additional 
    restrictions compared to the normal _Freedom Scoops_
    license. 
  ...
  * Be especially careful of “free textures” (or “free sounds” or
    ...
    commercially).
  * The project must be compatible with vanilla DOS and above, 
...
_Doom_’s original format, not in “Hexen” or "GZDoom"-format.
...
Since Freedom Scoops is a unique and original project, it's crucial to avoid using 
any brand names, such as "Chex," which is a trademark of General Mills.
Instead, we create and use entirely fictional names with no connection to real-world brands. 
For example, "Freedom Scoops" can represent a blend of different cereals 
and unrelated to any existing products or trademarks. A made up fictional name like 
"Galactic Nutritional Alliance or (G.N.A.)" with can be used on surfaces 
and textures as an example of this approach or something generic should do.
...
https://discord.gg/TSFYwTPqUk/[discord] just to keep his projects organized. 
